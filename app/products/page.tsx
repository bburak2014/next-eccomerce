...
//import ProductFilter from '@/components/ProductFilter';import Pagination from '@/components/Pagination';
  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <div className="grid grid-cols-3 gap-4">
        {productsData.products.map((product: { id: number; title: string }) => (
          <li key={product.id}>{product.title}</li>
        ))}
      </div>
      <Pagination totalPages={productsData.total} />
    </div>
  );
}
